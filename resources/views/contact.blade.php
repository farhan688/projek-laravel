        ...
        <div class="max-w-2xl  mx-auto bg-gray-200 rounded-lg p-16">
            ...
            <form action="{{ route('create.biodata') }}" method="POST">
                ...
                <div class="grid gap-6 mb-6 lg:grid-cols-2">
                    ...
                    <div>
                        <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Nama
                            Belakang</label>
                    ...
                    <div>
                        <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 ">Nomer Telpon</label>
                        <input type="tel" id="phone" name="phone"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                            placeholder="123-45-678">
                    </div>
                    <div>
                        <label for="visitors" class="block mb-2 text-sm font-medium text-gray-900 ">jenjang
                            studi</label>
